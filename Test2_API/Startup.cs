...
namespace Test2_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            builder.Database = "ISPr24-39_BeluakovDS_Api_Database_School_ABCDWQA";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Test2_API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Test2_API v1"));
            }
